...
void main()
{
    ...
    int xBall = 20, yBall = 20, xBallPrev = 128/2, yBallPrev = 64/2;
    int dx = 2, dy = 1;
    ...
    while(1)
    {
        ...
        {
            tracerBarre(128 -4 -3, previousYBar, 0);
            tracerBarre(128 -4 -3, yBar, 1);
        }
        if(yBarOppo != previousYBarOppo)
        {
            tracerBarre(4, previousYBarOppo, 0);
            tracerBarre(4, yBarOppo, 1);
        }
